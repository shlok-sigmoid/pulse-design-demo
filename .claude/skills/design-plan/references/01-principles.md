...
2. **No red, ever — and no magenta.** Negative/danger is burnt orange (`neg #bb3e0b`, deeper `#9a3412`) — urgent without ever borrowing error-red; the old magenta family was retired in v1.9.
